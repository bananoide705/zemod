...
NCountry = {
	...
	PARADROP_AIR_SUPERIORITY_RATIO = 0.5,			-- Min ratio of air superiority for paradropping
...
NMilitary = {
	...
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.90,	       -- more AA attack will approach this amount of help (diminishing returns)
	ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 61, -- how quickly defense approaches the max impact diminishing returns curve
	ENEMY_AIR_SUPERIORITY_SPEED_IMPACT = 0,     -- effect on speed due to enemy air superiority
	...
	UNIT_DIGIN_SPEED = 0.4,						   -- how "deep" you can dig a day.
	...
	MAX_OUT_OF_SUPPLY_DAYS = 15, 				   -- how many days of shitty supply until max penalty achieved
...
NNavy = {
	...
	CONVOY_LOSS_HISTORY_TIMEOUT_MONTHS = 6,						-- after this many months remove the history of lost convoys to not bloat savegames and memory since there is no way to see them anyway
	...
	XP_GAIN_FACTOR = 5.0,	   			   							-- xp gain factor for navy
